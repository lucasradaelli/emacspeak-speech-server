...
bool TTS::InitECI() {
  ...
  eciVersion = (void (*)(char *))(unsigned long)dlsym(eciLib, "eciVersion");
  eciGetAvailableLanguages = (int (*)(enum ECILanguageDialect *, int *))(
      unsigned long)dlsym(eciLib, "eciGetAvailableLanguages");
  eciNewEx = (void *(*)(enum ECILanguageDialect))(unsigned long)dlsym(
      eciLib, "eciNewEx");
  eciDelete = (void (*)(void *))(unsigned long)dlsym(eciLib, "eciDelete");
  ...
  eciPause = (int (*)(void *, int))(unsigned long)dlsym(eciLib, "eciPause");
  eciSynthesize =
      (int (*)(void *))(unsigned long)dlsym(eciLib, "eciSynthesize");
  eciSynchronize =
      (int (*)(void *))(unsigned long)dlsym(eciLib, "eciSynchronize");
  eciSpeaking = (int (*)(void *))(unsigned long)dlsym(eciLib, "eciSpeaking");
  eciInsertIndex =
  ...
  eciGetVoiceParam = (int (*)(void *, int, int))(unsigned long)dlsym(
